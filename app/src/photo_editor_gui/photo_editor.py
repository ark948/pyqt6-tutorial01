...
class MainWindow(QMainWindow):
    ...
    def createActions(self):
        ...
        self.print_act.setEnabled(False) # only becomes enabled when an image is set on image_label
    ...
    def clearImage(self):
        """ Clears the current image in the QLabel widget. """
        self.image_label.clear()
        self.image = QPixmap()
        self.print_act.setEnabled(False)

    def rotateImage90(self):
        # use alt+248 to type degrees symbol (using numpad)
    ...
    def printImage(self):
        ...
        if print_dialog.exec() == QDialog.DialogCode.Accepted:
            ...
            # current viewport, which is the image_label
