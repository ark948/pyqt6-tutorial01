import sys
from PyQt6.QtWidgets import (QApplication, QWidget, QLabel, QComboBox, QSpinBox, QHBoxLayout, QVBoxLayout, QPushButton, QDateEdit, QLineEdit, QTextEdit, QFormLayout)
...
class MainWindow(QWidget):
    ...
    def setUpMainWindow(self):
        ...
        header_label.setFont(QFont("Segoe", 18))
    ...
    def checkFormInformation(self):
        if self.first_name_edit.text() == "" or self.last_name_edit.text() == "":
            ...
            self.feedback_label.setText("OK, Accepted.")
